...
# boundaries of each message before passing it to hyperspec to be decoded.
...
class Del(hyperspec.Struct, tag=True):
    key: str


class ListKeys(hyperspec.Struct, tag=True):
    pass
...
class Server:
    """An example TCP key-value server using asyncio and hyperspec"""
...
class Client:
    """An example TCP key-value client using asyncio and hyperspec."""
