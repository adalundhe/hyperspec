...
html_theme_options = {
    "light_logo": "hyperspec-logo-light.svg",
    "dark_logo": "hyperspec-logo-dark.svg",
    "light_css_variables": {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/jcrist/hyperspec",
            "html": GITHUB_LOGO,
            "class": "",
        },
    ],
...
default_role = "obj"
extlinks = {
    "issue": ("https://github.com/jcrist/hyperspec/issues/%s", "Issue #%s"),
    "pr": ("https://github.com/jcrist/hyperspec/pull/%s", "PR #%s"),
}
