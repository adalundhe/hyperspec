...
``hyperspec`` goes above and beyond other Python JSON libraries to help with the
following:
...
- **Validation**
  ...
  ``hyperspec`` lets you describe your schema via type annotations, and will
...
- **Application Logic**
  ...
  ``hyperspec`` supports a :doc:`wide variety of types <supported-types>`,
...
- **Future Flexibility**
  ...
  To handle this, ``hyperspec`` supports :doc:`"schema evolution"
...
While there are other tools in this space, ``hyperspec`` should be an :doc:`order
