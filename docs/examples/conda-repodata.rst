...
- ``hyperspec`` is the fastest option tested. It relies on defining a known
...
<https://github.com/jcrist/hyperspec/tree/main/examples/conda-repodata>`__.
